...
<header class="page-header">
    <div class="container">
        <h1 class="title">天赐系列</h1>
    </div>
</header>
<div class="container">
    <h6>天赐系列对人的意义是什么，什么是天赐系列，加各种广告语 </h6>
</div>
<div class="container">
    <div class="title-box">
...
<div class="container">
    <div class="title-box">
        <h2 class="h1 title">案例</h2>
    </div>

    <p>下面是一些做了基因检测的普通人或明星</p>

    <div class="row">
        <div class="col-sm-4 bottom-padding">
            <p class="text-center"><img class="img-rounded" src="http://placehold.it/370x185" width="370" height="185"
                                        alt=""></p>
            <h5><a href="#" class="no-border">案例一</a></h5>

            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Id pariatur molestiae illum cum facere deserunt
                a enim harum eaque fugit.</p>
        </div>

        <div class="col-sm-4 bottom-padding">
            <p class="text-center"><img class="img-rounded" src="http://placehold.it/370x185" width="370" height="185"
                                        alt=""></p>
            <h5><a href="#" class="no-border">案例二</a></h5>
        ...
        <div class="col-sm-4 bottom-padding">
            <p class="text-center"><img class="img-rounded" src="http://placehold.it/370x185" width="370" height="185"
                                        alt=""></p>
            <h5><a href="#" class="no-border">案例三</a></h5>
    ...
    <div class="row">
        <div class="col-sm-8">
            <h5>对我们的服务感兴趣了吗？ 或者有问题要问？<br>和我们打声招呼吧！</h5>
        </div>
        <div class="col-sm-4 text-right text-center-mobile">
            <a href="#" class="btn btn-lg btn-primary">现在就来联系我们</a>
        </div>
    </div>

    <div class="bottom-padding">
        <div class="title-box">
            <h2 class="h1 title">套餐</h2>
        </div>
        ...
        <div class="pricings row">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="pricing prising-info">
                    <div class="title"><a href="#">套餐2</a></div>
                    <div class="price-box">
                        <div class="icon icon-60 pull-right border circle">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="pricing pricing-success">
                    <div class="title"><a href="#">套餐3</a></div>
                    <div class="price-box">
                        <div class="icon icon-60 pull-right border circle">
            ...
            <div class="col-sm-6 col-md-4 col-md-offset-4 col-lg-3 col-lg-offset-0">
                <div class="pricing pricing-error">
                    <div class="title"><a href="#">套餐4</a></div>
                    <div class="price-box">
                        <div class="icon icon-60 pull-right border circle">
            ...
            <div class="col-sm-6 col-md-4 col-md-offset-3 col-lg-3">
                <div class="pricing ">
                    <div class="title"><a href="#">套餐5</a></div>
                    <div class="price-box">
                        <div class="icon icon-60 pull-right border circle">
                            <i class="fa fa-gift"></i>
                        </div>
                ...
                <div class="pricing ">
                    <div class="title"><a href="#">套餐6</a></div>
                    <div class="price-box">
                        <div class="icon icon-60 pull-right border circle">
                            <i class="fa fa-gift"></i>
                        </div>
